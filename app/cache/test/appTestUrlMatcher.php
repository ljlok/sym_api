...
class appTestUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/api')) {
            ...
            // api_1_get_user
            if (0 === strpos($pathinfo, '/api/v1/users') && preg_match('#^/api/v1/users/(?P<id>[^/\\.]++)(?:\\.(?P<_format>xml|json|html))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_1_get_user;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'api_1_get_user')), array (  '_controller' => 'Acme\\BhiBundle\\Controller\\UserController::getUserAction',  '_format' => NULL,));
            }
            not_api_1_get_user:
